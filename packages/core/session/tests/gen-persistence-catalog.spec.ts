...
describe('gen-persistence-catalog annotateSurface + render', () => {
  ...
  it('renders badges, declaration fences, and the generated-file header', () => {
    ...
    expect(out).toContain('<!-- 由 scripts/gen-persistence-catalog.ts 生成——请勿手工编辑。')
    expect(out).toContain('# 会话持久化事件目录')
    ...
    expect(out).toContain('来源：[`packages/core/fix/src/types.ts:3`](../packages/core/fix/src/types.ts)')
  })
})
