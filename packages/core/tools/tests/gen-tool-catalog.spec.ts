...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'advance_delivery_task', 'ask_user_question', 'bash', 'bash', 'cordis_define', 'cordis_inspect_list',
      'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop',
      'cordis_undefine', 'create_delivery_task', 'create_goal', 'edit', 'exit_plan_mode', 'followup_task',
      'get_delivery_task', 'get_goal', 'glob', 'grep',
      ...
      'read', 'read_image', 'record_change', 'record_design', 'record_spec', 'report', 'run_code',
