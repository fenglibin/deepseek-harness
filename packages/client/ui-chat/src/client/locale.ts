...
export const en = {
  ...
  'chat.userTurnList.title': 'My conversation',
  'chat.userTurnList.toggle': 'Open user message list',
  'chat.userTurnList.total': '{count} user messages total',
  'chat.userTurnList.totalInline': '{count} total',
