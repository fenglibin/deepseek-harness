...
export const zh = {
  ...
  'delete.session.live': '该会话仍在运行，暂时无法删除。请先归档会话，或稍后重试。',
  'menu.fork': '分叉会话',
...
export const en = {
  ...
  'delete.session.live': 'This session is still running and cannot be deleted yet. Archive it first, or try again later.',
