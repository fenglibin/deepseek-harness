...
export const en = {
  ...
  add: 'Add model',
  addDescription: 'Choose a provider, or enter an API base URL to declare one by hand.',
  addProviderPlaceholder: 'Choose a provider…',
  addManualUrl: 'Or enter an API base URL',
  addManualContinue: 'Continue',
  addBack: 'Back',
  addNoneAddable: 'Every provider in the adapter directory is already configured.',
  provider: 'Provider',
  close: 'Close',
  cancel: 'Cancel',
  apply: 'Apply',
  ...
  fetchFilter: 'Filter models',
  fetchNoMatch: 'No model matches this filter.',
  ...
  lightweightModelHint: "Auxiliary calls such as session titles and compaction use this model instead of the conversation's own model.",
  lightweightModelUnset: 'None — follow the conversation model',
  lightweightModelReadOnly: 'This browser cannot change the lightweight model.',
  lightweightModelSave: 'Save',
  lightweightModelDiscard: 'Discard',
  lightweightModelSaving: 'Saving…',
  lightweightModelFailed: 'The lightweight model could not be saved.',
  lightweightModelEmpty: 'No model is available to choose from.',
  lightweightModelRetrying: 'Loading the model catalog…',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  addManualContinue: '继续',
  addBack: '返回',
  addNoneAddable: '适配器目录中的提供方都已添加。',
  provider: '提供方',
  close: '关闭',
  cancel: '取消',
  apply: '保存',
  ...
  lightweightModelHint: '会话标题、上下文压缩等辅助调用将使用该模型，而不是会话自身的模型。',
  lightweightModelUnset: '不指定——跟随会话模型',
  lightweightModelReadOnly: '当前浏览器无法修改轻量模型。',
  lightweightModelSave: '保存',
  lightweightModelDiscard: '放弃',
  lightweightModelSaving: '保存中…',
