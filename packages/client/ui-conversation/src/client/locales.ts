...
export const zh = {
  ...
  'input.resize': '调整输入框高度',
  'input.resizeTitle': '拖动调整高度，双击恢复默认高度',
...
export const en = {
  ...
  'input.resize': 'Resize the composer',
  'input.resizeTitle': 'Drag to resize. Double-click to reset.',
  ...
  'bash.showAll': 'Show all',
  'bash.collapseAll': 'Collapse',
  'row.running': 'Running',
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
  'row.input': 'IN',
  ...
  'row.inspect': 'Inspect',
  'row.op.added': 'Added',
  'row.op.modified': 'Modified',
  'row.op.deleted': 'Deleted',
  'row.viewChange': 'View change',
  'row.hideChange': 'Hide change',
