...
The [evidence-chain decision](../../notes/implemented/process/2026-08-08-browser-gif-evidence-chain.zh.md) owns why one storyboard comes from one isolated run and why publication revalidates both the artifact and the demonstrated pull-request head.
