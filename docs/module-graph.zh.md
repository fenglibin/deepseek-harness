...
flowchart TD
  ...
  subgraph group_llm["packages/llm"]
    ...
    pkg_llm_failover["llm-failover"]
    pkg_llm_pi_ai["llm-pi-ai"]
    pkg_llm_retry["llm-retry"]
    pkg_llm_round_robin["llm-round-robin"]
  ...
  subgraph group_api["packages/api"]
    pkg_api_file_browser["api-file-browser"]
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_file_browser["client-ui-file-browser"]
    ...
    pkg_client_ui_session_changes["client-ui-session-changes"]
    pkg_client_ui_settings["client-ui-settings"]
    pkg_client_ui_settings_commands["client-ui-settings-commands"]
  ...
  subgraph group_interaction["packages/interaction"]
    pkg_command_prompt_config["command-prompt-config"]
  ...
  pkg_image_understanding --> pkg_attachment
  pkg_image_understanding --> pkg_invariants
  pkg_image_understanding --> pkg_llm
  pkg_image_understanding --> pkg_settings
  ...
  pkg_response_language --> pkg_settings
  ...
  pkg_llm_failover --> pkg_agent
  pkg_llm_failover --> pkg_invariants
  pkg_llm_failover --> pkg_llm
  ...
  pkg_llm_round_robin --> pkg_agent
  pkg_llm_round_robin --> pkg_invariants
  pkg_llm_round_robin --> pkg_llm
  ...
  pkg_skill_filesystem --> pkg_scope
  ...
  pkg_api_file_browser --> pkg_invariants
  pkg_api_file_browser --> pkg_typert_protocol
  pkg_api_file_browser --> pkg_workspace
  ...
  pkg_delivery --> pkg_agent
  pkg_delivery --> pkg_brand
  pkg_delivery --> pkg_invariants
  pkg_delivery --> pkg_llm
  pkg_delivery --> pkg_scope
  pkg_delivery --> pkg_session
  pkg_delivery --> pkg_session_projection
  pkg_fs_e2b --> pkg_e2b
  pkg_fs_e2b --> pkg_fs
  ...
  pkg_host_skill_manager --> pkg_atomic_write
  pkg_host_skill_manager --> pkg_brand
  pkg_host_skill_manager --> pkg_invariants
  pkg_host_skill_manager --> pkg_skill
  pkg_host_skill_manager --> pkg_skill_filesystem
  pkg_host_skill_manager --> pkg_typert_protocol
  pkg_command_prompt_config --> pkg_commands
  pkg_command_prompt_config --> pkg_invariants
  pkg_command_prompt_config --> pkg_settings
  ...
  pkg_session_title_llm --> pkg_lightweight_model
  ...
  pkg_agent_loop --> pkg_image_understanding
  ...
  pkg_tool_delivery --> pkg_agent
  pkg_tool_delivery --> pkg_delivery
  ...
  pkg_compaction_basic --> pkg_lightweight_model
  ...
  pkg_mcp_manager --> pkg_authorization
  pkg_mcp_manager --> pkg_credentials
  ...
  pkg_tool_subagent --> pkg_llm_retry
  ...
  pkg_api_session_controller --> pkg_image_understanding
  ...
  pkg_sdk_jsonrpc_server --> pkg_image_understanding
...
| [`client-ui-delivery`](../packages/client/ui-delivery) | `client` | — |
...
| [`client-ui-file-browser`](../packages/client/ui-file-browser) | `client` | — |
...
| [`client-ui-session-changes`](../packages/client/ui-session-changes) | `client` | — |
| [`client-ui-settings`](../packages/client/ui-settings) | `client` | — |
| [`client-ui-settings-commands`](../packages/client/ui-settings-commands) | `client` | — |
...
| [`llm-failover`](../packages/llm/llm-failover) | `llm` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm) |
...
| [`llm-round-robin`](../packages/llm/llm-round-robin) | `llm` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm) |
...
| [`skill-filesystem`](../packages/skill/skill-filesystem) | `skill` | [`fs`](../packages/fs/fs), [`home-paths`](../packages/util/home-paths), [`invariants`](../packages/runtime-diagnostics/invariants), [`scope`](../packages/core/scope), [`skill`](../packages/skill/skill) |
...
| [`api-file-browser`](../packages/api/file-browser) | `api` | [`invariants`](../packages/runtime-diagnostics/invariants), [`typert-protocol`](../packages/typert/protocol), [`workspace`](../packages/workspace/workspace) |
...
| [`delivery`](../packages/delivery/delivery) | `delivery` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection) |
...
| [`host-skill-manager`](../packages/host/skill-manager) | `host` | [`atomic-write`](../packages/util/atomic-write), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`skill`](../packages/skill/skill), [`skill-filesystem`](../packages/skill/skill-filesystem), [`typert-protocol`](../packages/typert/protocol) |
| [`command-prompt-config`](../packages/interaction/command-prompt-config) | `interaction` | [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings) |
...
| [`session-title-llm`](../packages/session/session-title-llm) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`lightweight-model`](../packages/core/lightweight-model), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-title`](../packages/session/session-title), [`timeout`](../packages/util/timeout) |
...
| [`mcp-manager`](../packages/mcp/mcp-manager) | `mcp` | [`authorization`](../packages/credentials/authorization), [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`mcp-client`](../packages/mcp/mcp-client), [`settings`](../packages/settings/settings), [`tools`](../packages/core/tools), [`typert-protocol`](../packages/typert/protocol) |
...
| [`tool-subagent`](../packages/subagent/tool-subagent) | `subagent` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`llm-retry`](../packages/llm/llm-retry), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`settings`](../packages/settings/settings), [`subagent`](../packages/subagent/subagent), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
