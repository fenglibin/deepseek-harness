...
Source: [`packages/interaction/command-prompt-config/src/index.ts:50`](../packages/interaction/command-prompt-config/src/index.ts)
...
Source: [`packages/core/lightweight-model/src/index.ts:45`](../packages/core/lightweight-model/src/index.ts)
...
Requires: `agents` · `delivery` · `tools` · `fs` · `shell` · `systemPrompt`
...
Source: [`packages/delivery/tool-delivery/src/index.ts:41`](../packages/delivery/tool-delivery/src/index.ts)
...
- `@deepseek-ai/dsh-delivery` — requires `agents` · `sessionProjections` ([`packages/delivery/delivery/src/index.ts`](../packages/delivery/delivery/src/index.ts))
